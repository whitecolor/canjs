...
g-1&&/^f|^o/.test(typeof m);k++)m=d[k]in m?m[d[k]]:c&&(m[d[k]]={});if(/^f|^o/.test(typeof m)&&(e=d[k]in m?m[d[k]]:c&&(m[d[k]]={}),void 0!==e))return!1===c&&delete m[d[k]],e;n++}},capitalize:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},underscore:function(a){return a.replace(i,"/").replace(j,"$1_$2").replace(e,"$1_$2").replace(c,"_").toLowerCase()},sub:function(d,b,c){var g=[];g.push(d.replace(f,function(d,n){var e=a.getObject(n,b,void 0===c?c:!c);return void 0===e?(g=null,""):/^f|^o/.test(typeof e)&&
...
window,!0);var o=a.underscore(j.replace(/\./g,"_")),m=a.underscore(h);d[h]=f}a.extend(f,{constructor:f,prototype:l,namespace:b,shortName:h,_shortName:m,fullName:j,_fullName:o});f.prototype.constructor=f;h=[this].concat(a.makeArray(arguments));l=f.setup.apply(f,h);f.init&&f.init.apply(f,l||h);return f}});return a.Construct}(module["can/util/string/string.js"]);
...
'"'+(b||"")+");")},D=[],w,z=null,I=!1,A="",B=[],E=0,v,u=this.tokenMap;for(g=h=b=null;void 0!==(v=e[E++]);){if(null===z)switch(v){case u.left:case u.escapeLeft:case u.returnLeft:I=g&&1;case u.commentLeft:z=v;p.length&&x(p);p="";break;case u.escapeFull:I=g&&1;l=1;z=u.escapeLeft;p.length&&x(p);l=e[E++];p=l.content||l;l.before&&x(l.before);e.splice(E,0,u.right);break;case u.commentFull:break;case u.templateLeft:p+=u.left;break;case "<":0!==e[E].indexOf("!--")&&(g=1,I=0);p+=v;break;case ">":g=0;w="/"==
...
module["can/observe/compute/compute.js"]=function(a){var i=function(e,c){var f;a.Observe&&(f=a.Observe.__reading,a.Observe.__reading=function(a,b){d.push({obj:a,attr:b})});var d=[],g=e.call(c);a.Observe&&(a.Observe.__reading=f);return{value:g,observed:d}},j=function(e,c,f){var d={},g=!0,h={value:void 0,teardown:function(){for(var a in d){var b=d[a];b.observe.obj.unbind(b.observe.attr,l);delete d[a]}}},b,l=function(a){if(void 0===a.batchNum||a.batchNum!==b){var d=h.value,c=o();h.value=c;c!==d&&f(c,
d);b=b=a.batchNum}},o=function(){var b=i(e,c),h=b.observed,b=b.value;g=!g;a.each(h,function(a){d[a.obj._cid+"|"+a.attr]?d[a.obj._cid+"|"+a.attr].matched=g:(d[a.obj._cid+"|"+a.attr]={matched:g,observe:a},a.obj.bind(a.attr,l))});for(var f in d)h=d[f],h.matched!==g&&(h.observe.obj.unbind(h.observe.attr,l),delete d[f]);return b};h.value=o();h.isListening=!a.isEmptyObject(d);return h};a.compute=function(e,c){if(e&&e.isComputed)return e;var f,d=0,g,h=!0;"function"===typeof e?g=function(b){return void 0===
...
function(b,d,c){var k=b.nodeName.toString().toLowerCase(),h=e[d];if(h){if(b[h]=-1<a.inArray(d,g)?!0:c,"value"===h&&("input"===k||"textarea"===k))b.defaultValue=c}else b.setAttribute(d,c)},b=[],l=function(a){if("string"==typeof a)return a;if(!a&&0!==a)return"";var d=a.hookup&&function(b,d){a.hookup.call(a,b,d)}||"function"==typeof a&&a;return d?(b.push(d),""):""+a},o=function(b){return"string"==typeof b||"number"==typeof b?a.esc(b):l(b)},m={},n={},q={},k="ejs_"+Math.random(),r=0,s=function(a){if(i||
...
function(a){a(b)})})},registerNode:function(b){var d=s(b);q[d]=b;a.each(b,function(a){t(a,d)})},unregisterNode:function(b){var d=s(b);a.each(b,function(a){p(a,d)});delete q[d]},txt:function(k,n,r,m,p){var i=a.compute.binder(p,m,function(a,b){C(a,b)});if(!i.isListening)return(k||0!==r?o:l)(i.value);var j,s,q=function(){i.teardown();s&&a.view.unregisterNode(s)},t=function(b){a.bind.call(b,"destroyed",q);j=b},F=function(b){b||(q(),a.unbind.call(j,"destroyed",q))},m=c[n]||"span",C,G=d[n];if(0===r&&!G)return"<"+
...
(k=a.makeArray(c),a.view.replace(c,e),a.remove(a.$(k))):(a.remove(a.$(b)),s=c=e,a.view.registerNode(c))};e(i.value,[b]);t(d)})+">"+x(m)+"</"+m+">";if(1===r){var H=i.value.replace(/['"]/g,"").split("=")[0];b.push(function(b){C=function(d){var d=(d||"").replace(/['"]/g,"").split("="),c=d[0];if(c!=H&&H){var e=H;-1<a.inArray(e,g)?b[e]=!1:b.removeAttribute(e)}c&&(h(b,c,d[1]),H=c)};t(b)});return i.value}var y=0===r?G:r;(0===r?lastHookups:b).push(function(b){C=function(){h(b,y,n.render(),G)};var d=a.$(b),
c;(c=a.data(d,"hooks"))||a.data(d,"hooks",c={});var k=(e[y]?b[e[y]]:b.getAttribute(y))||"",d=k.split("__!!__"),g=[],n;g.push(d.shift(),d.join("__!!__"));c[y]?c[y].bindings.push(i):c[y]={render:function(){var a=0;return k.replace(f,function(){return l(n.bindings[a++].value)})},bindings:[i],batchNum:void 0};n=c[y];g.splice(1,0,i.value);h(b,y,g.join(""),G);t(b)});return"__!!__"},replace:function(b,d){b=a.makeArray(b);a.each(b,function(c){a.each(a.makeArray(m[s(c)]),function(e){var k=q[e],g=a.inArray(c,
k),h=a.inArray(b[b.length-1],k);if(0<=g&&0<=h){for(var f=g;f<=h;f++)p(k[f],e);k.splice.apply(k,[g,h-g+1].concat(d));a.each(d,function(a){t(a,e)})}else a.view.unregisterNode(k)})})},canExpando:i,textNodeMap:n,nodeMap:m,nodeListMap:q});return a}(module["can/view/view.js"],module["can/util/string/string.js"]);
...
b),e,f=this,g;m.startBatch();this.each(function(c,e){g=b[e];void 0===g?d&&f.removeAttr(e):(f.__convert&&(g=f.__convert(e,g)),g instanceof a.Observe?f.__set(e,g,c):i(c)&&i(g)&&c.attr?c.attr(g,d):c!=g&&f.__set(e,g,c),delete b[e])});for(e in b)g=b[e],this._set(e,g);m.stopBatch();return this},compute:function(b){var c=this,d=function(a){return c.attr(b,a)};return a.compute?a.compute(d):d}}),n=[].splice,q=m({setup:function(b,c){this.length=0;a.cid(this,".observe");this._init=1;this.push.apply(this,a.makeArray(b||
...
reverse:[].reverse,slice:function(){return new this.constructor(Array.prototype.slice.apply(this,arguments))},concat:function(){var b=[];a.each(a.makeArray(arguments),function(c,d){b[d]=c instanceof a.Observe.List?c.serialize():c});return new this.constructor(Array.prototype.concat.apply(this.serialize(),b))},forEach:function(b,c){a.each(this,b,c||this)},replace:function(b){a.isDeferred(b)?b.then(a.proxy(this.replace,this)):this.splice.apply(this,[0,this.length].concat(a.makeArray(b||[])));return this}});
m.List=q;m.setup=function(){a.Construct.setup.apply(this,arguments);this.List=m.List({Observe:this},{})};return m}(module["can/util/jquery/jquery.js"],module["can/construct/construct.js"]);
...
module["can/observe/delegate/delegate.js"]=function(a){var i=function(a,c){var f=a.length,d=0,g=[],h;for(d;d<f;d++){h=c[d];if("string"!==typeof h)return null;if("**"==a[d])return c.join(".");if("*"==a[d])g.push(h);else if(h===a[d])g.push(h);else return null}return g.join(".")},j=function(e,c,f,d,g){var h=c.split("."),b=(this._observe_delegates||[]).slice(0),l,j,m,n,q;e.attr=c;e.lastAttr=h[h.length-1];for(var k=0;l=b[k++];)if(!(e.batchNum&&l.batchNum===e.batchNum||l.undelegated)){n=void 0;q=!0;for(var r=
0;r<l.attrs.length;r++){j=l.attrs[r];if(m=i(j.parts,h))n=m;j.value&&q?q=j.value===""+this.attr(j.attr):q&&1<l.attrs.length&&(q=void 0!==this.attr(j.attr))}n&&q&&((j=c.replace(n+".",""),e.batchNum&&(l.batchNum=e.batchNum),"change"===l.event)?(arguments[1]=j,e.curAttr=n,l.callback.apply(this.attr(n),a.makeArray(arguments))):l.event===f?l.callback.apply(this.attr(n),[e,d,g,j]):"set"===l.event&&"add"==f&&l.callback.apply(this.attr(n),[e,d,g,j]))}};a.extend(a.Observe.prototype,{delegate:function(e,c,f){for(var e=
...
module["can/util/object/object.js"]=function(a){var i=a.isArray;a.Object={};var j=a.Object.same=function(c,f,d,g,h,b){var l=typeof c,o=i(c),m=typeof d;if("string"==m||null===d)d=e[d],m="function";if("function"==m)return d(c,f,g,h);d=d||{};if(c instanceof Date)return c===f;if(-1===b)return"object"===l||c===f;if(l!==typeof f||o!==i(f))return!1;if(c===f)return!0;if(o){if(c.length!==f.length)return!1;for(b=0;b<c.length;b++)if(g=void 0===d[b]?d["*"]:d[b],!j(c[b],f[b],c,f,g))return!1;return!0}if("object"===
